...
func (s *CompServicesImpl) GetPricingStartHotelRooms(ctx *gin.Context, data []models.HotelRooms) int64 {
...
func (s *CompServicesImpl) GetReviewAverageRating(ctx *gin.Context, data []models.HotelReviews) dto.HotelAverageRating {
...
func (s *CompServicesImpl) GetReviewStatistics(ctx *gin.Context, data []models.HotelReviews) dto.HotelReviewStatistic {
